...
@app.route('/')
def index():
    """Returns the styled upload page."""
    return '''
    <!DOCTYPE html>
    <html lang="en">
    <head>
                ...
                try {
                    ...
                    resultDiv.innerHTML = `
                        <div class="overall-emotion">
                            Overall Emotion: <strong>${result.overall_emotion}</strong>
                        </div>
                    `;
                    ...
                    result.segments.forEach(segment => {
                        ...
                        segmentDiv.innerHTML = `
                            <p><strong>${segment.speaker}</strong> (${segment.start.toFixed(1)}s - ${segment.end.toFixed(1)}s)</p>
                            <p>Emotion: <strong>${segment.emotion}</strong></p>
                            <p>${segment.text}</p>
                        `;
